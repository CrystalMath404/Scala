...
object PatternMatching extends App{
  ...
  println("1 " + testIntToString(1))
  println("2 " + testIntToString(2))
  println("3 " + testIntToString(3))
  println("9 " + testIntToString(9))
  println()
  ...
  println("Max " + testIsMaxAndMoritz("Max"))
  println("hey " + testIsMaxAndMoritz("hey"))
  println()
  ...
  println("3 " + testIsEven(3))
  println("4 " + testIsEven(4))
  println()
  ...
  println(testExtractMammalWeight(Mammal("Whale", Meat, 25000)))
  println()
  ...
  println(testUpdateFood(Fish("Shark", Meat)))
